...
# pt age bins
colname = 'AGE_DON'
df1 = df[df[colname] < 13]
df2 = df[df[colname].between(13, 19, inclusive='both')]
df3 = df[df[colname].between(20, 29, inclusive='both')]
df4 = df[df[colname].between(30, 39, inclusive='both')]
df5 = df[df[colname].between(40, 49, inclusive='both')]
df6 = df[df[colname].between(50, 59, inclusive='both')]
df7 = df[df[colname].between(60, 69, inclusive='both')]
df8 = df[df[colname] > 69]
...
ax = plotdf.plot.bar(
    rot=0,
    title='Actual vs Predicted Survival in Years - Donor Age',
    xlabel='Donor Age (#Recipients)',
    ylabel='Recipient Survival in Years',
    fontsize=12,
    color={
       'Actual-Mean': '#94c6eb',
